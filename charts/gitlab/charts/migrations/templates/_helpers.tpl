...
{{- define "migrations.predeploy.jobname" -}}
{{- $name := include "fullname" . | trunc 55 | trimSuffix "-" -}}
{{- printf "%s-predeploy.%d" $name .Release.Revision | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "migrations.predeploy.jobname" -}}
{{- $name := include "fullname" . | trunc 55 | trimSuffix "-" -}}
{{- printf "%s-postdeploy.%d" $name .Release.Revision | trunc 63 | trimSuffix "-" -}}
{{- end -}}
